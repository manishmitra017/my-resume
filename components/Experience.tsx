      ...
      roles: [
        {
          ...
          description: "Principal QE Engineer leading quality transformation across 15 squads (120 engineers)",
          highlights: [
            "Established QE framework reducing production bugs by 60% and deployment failures from 18% to 2.3%",
            "Built automated testing platform (Playwright, Cypress) reducing QA cycle time from 2 weeks to 3 days",
            "Architected event-driven testing framework for MSK Kafka reducing E2E test execution by 70%",
            "Implemented contract testing (PACT Flow) across 40+ microservices, catching 85% of integration issues pre-prod",
            "Saved $2.1M annually through test automation and reduced manual testing overhead",
          ],
        },
      ],
    },
      ...
      roles: [
        {
          ...
          description: "Testing Chapter Lead for BX Tribe (37 squads, 280+ engineers, 8 countries)",
          highlights: [
            "Transformed testing culture across 37 squads reducing production defects by 73% and deployment failures from 18% to 2.3%",
            "Built automated testing platform reducing QA cycle time from 2 weeks to 3 days, enabling daily releases",
            "Mentored 12 QE coaches across APAC region, promoting 5 to senior/principal roles within 18 months",
            "Established testing standards and best practices adopted by 280+ engineers across organization",
            "Saved $4.2M annually through test automation, reduced manual testing, and improved deployment efficiency",
          ],
        },
      ],
    },
      ...
      roles: [
        {
          ...
          description: "Data Lake Quality Engineering Manager",
          highlights: [
            "Built data quality framework for petabyte-scale data lake processing 5M+ daily records",
            "Automated Airflow pipeline testing reducing data quality incidents by 82%",
            "Developed infrastructure testing framework (Python, Boto3, TerraTest) validating AWS deployments",
            "Reduced data pipeline failure rate from 12% to 1.5% through comprehensive testing strategy",
          ],
        },
        {
          title: "Senior Consultant Quality Engineering",
          period: "March 2018 - October 2020",
          description: "Business Banking Engineering Labs - Test Infrastructure Lead",
          highlights: [
            "Built containerized test pipeline (Docker, Express) processing 500+ daily deployments with 99.5% success rate",
            "Architected AWS testing infrastructure with Terraform reducing environment provisioning from 3 days to 30 minutes",
            "Implemented comprehensive testing strategy (Cypress, Jest, Gatling) improving test coverage from 45% to 92%",
            "Established performance testing framework preventing 15+ production incidents through load testing",
          ],
        },
      ],
    },
